...
class $ProfileEntriesTable extends ProfileEntries
  ...
  static const VerificationMeta _populatedHeadersMeta = const VerificationMeta(
    'populatedHeaders',
  );
  @override
  ...
  static const VerificationMeta _profileOverrideMeta = const VerificationMeta(
    'profileOverride',
  );
  @override
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('populated_headers')) {
      context.handle(
        ...
        populatedHeaders.isAcceptableOrUnknown(
          data['populated_headers']!,
          _populatedHeadersMeta,
        ),
      );
    }
    if (data.containsKey('profile_override')) {
      context.handle(
        ...
        profileOverride.isAcceptableOrUnknown(
...
class $AppProxyEntriesTable extends AppProxyEntries
    with TableInfo<$AppProxyEntriesTable, AppProxyEntry> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $AppProxyEntriesTable(this.attachedDatabase, [this._alias]);
  @override
  late final GeneratedColumnWithTypeConverter<AppProxyMode, String> mode =
      GeneratedColumn<String>(
        'mode',
        aliasedName,
        false,
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<AppProxyEntry> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  static JsonTypeConverter2<AppProxyMode, String, String> $convertermode =
      const EnumNameConverter<AppProxyMode>(AppProxyMode.values);
}
...
class AppProxyEntry extends DataClass implements Insertable<AppProxyEntry> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    {
      map['mode'] = Variable<String>(
        $AppProxyEntriesTable.$convertermode.toSql(mode),
      );
    }
  ...
  factory AppProxyEntry.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return AppProxyEntry(
      mode: $AppProxyEntriesTable.$convertermode.fromJson(
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      'mode': serializer.toJson<String>(
        $AppProxyEntriesTable.$convertermode.toJson(mode),
      ),
...
class AppProxyEntriesCompanion extends UpdateCompanion<AppProxyEntry> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (mode.present) {
      map['mode'] = Variable<String>(
        $AppProxyEntriesTable.$convertermode.toSql(mode.value),
      );
    }
    if (pkgName.present) {
...
abstract class _$Db extends GeneratedDatabase {
  ...
  late final $AppProxyEntriesTable appProxyEntries = $AppProxyEntriesTable(
    this,
  );
  @override
...
class $$ProfileEntriesTableFilterComposer
    extends Composer<_$Db, $ProfileEntriesTable> {
  ...
  ColumnFilters<String> get populatedHeaders => $composableBuilder(
    column: $table.populatedHeaders,
    builder: (column) => ColumnFilters(column),
  );

  ColumnFilters<String> get profileOverride => $composableBuilder(
    column: $table.profileOverride,
    builder: (column) => ColumnFilters(column),
  );

  ColumnFilters<String> get userOverride => $composableBuilder(
...
class $$ProfileEntriesTableOrderingComposer
  ...
  ColumnOrderings<String> get populatedHeaders => $composableBuilder(
    column: $table.populatedHeaders,
    builder: (column) => ColumnOrderings(column),
  );

  ColumnOrderings<String> get profileOverride => $composableBuilder(
    column: $table.profileOverride,
    builder: (column) => ColumnOrderings(column),
  );

  ColumnOrderings<String> get userOverride => $composableBuilder(
    column: $table.userOverride,
    builder: (column) => ColumnOrderings(column),
  );
}
...
class $$ProfileEntriesTableAnnotationComposer
  ...
  GeneratedColumn<String> get populatedHeaders => $composableBuilder(
    column: $table.populatedHeaders,
    builder: (column) => column,
  );

  GeneratedColumn<String> get profileOverride => $composableBuilder(
    column: $table.profileOverride,
    builder: (column) => column,
  );

  GeneratedColumn<String> get userOverride => $composableBuilder(
    column: $table.userOverride,
    builder: (column) => column,
  );
}
...
class $$ProfileEntriesTableTableManager
    extends
        RootTableManager<
          ...
          (
            ProfileEntry,
            BaseReferences<_$Db, $ProfileEntriesTable, ProfileEntry>,
          ),
          ProfileEntry,
...
class $$AppProxyEntriesTableFilterComposer
    extends Composer<_$Db, $AppProxyEntriesTable> {
...
class $$AppProxyEntriesTableOrderingComposer
    extends Composer<_$Db, $AppProxyEntriesTable> {
...
class $$AppProxyEntriesTableAnnotationComposer
    extends Composer<_$Db, $AppProxyEntriesTable> {
...
class $$AppProxyEntriesTableTableManager
    extends
        RootTableManager<
          ...
          (
            AppProxyEntry,
            BaseReferences<_$Db, $AppProxyEntriesTable, AppProxyEntry>,
          ),
          AppProxyEntry,
          PrefetchHooks Function()
        > {
  $$AppProxyEntriesTableTableManager(_$Db db, $AppProxyEntriesTable table)
    : super(
        TableManagerState(
          ...
          table: table,
          createFilteringComposer: () =>
              $$AppProxyEntriesTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$AppProxyEntriesTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$AppProxyEntriesTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
