...
class MyAdaptiveLayout extends HookConsumerWidget {
  ...
  List<ShellRouteAction> _actions(Translations t, bool showProfilesAction, bool isMobileBreakpoint) => [
    ShellRouteAction(Icons.shield_outlined, t.pages.home.title),
    if (showProfilesAction && !isMobileBreakpoint) ShellRouteAction(Icons.window_outlined, t.pages.profiles.title),
    ShellRouteAction(Icons.settings_outlined, t.pages.settings.title),
    if (!isMobileBreakpoint) ShellRouteAction(Icons.description_outlined, t.pages.logs.title),
    if (!isMobileBreakpoint) ShellRouteAction(Icons.info_outline, t.pages.about.title),
  ];
