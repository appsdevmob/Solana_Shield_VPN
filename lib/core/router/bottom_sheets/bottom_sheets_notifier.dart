...
import 'package:hiddify/features/profile/add/free_profiles_modal.dart';
...
class BottomSheetsNotifier extends _$BottomSheetsNotifier {
  ...
  Future<void> showFreeProfiles() async => await _show(isScrollControlled: true, child: const FreeProfilesModal());
