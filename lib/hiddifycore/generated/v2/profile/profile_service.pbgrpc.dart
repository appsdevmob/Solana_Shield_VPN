...
class ProfileServiceClient extends $grpc.Client {
  static final _$getProfile = $grpc.ClientMethod<$3.ProfileRequest, $3.ProfileResponse>(
      '/profile.ProfileService/GetProfile',
      ($3.ProfileRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $3.ProfileResponse.fromBuffer(value));
  static final _$updateProfile = $grpc.ClientMethod<$4.ProfileEntity, $3.ProfileResponse>(
      '/profile.ProfileService/UpdateProfile',
      ($4.ProfileEntity value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $3.ProfileResponse.fromBuffer(value));
  static final _$getAllProfiles = $grpc.ClientMethod<$1.Empty, $3.MultiProfilesResponse>(
      '/profile.ProfileService/GetAllProfiles',
      ($1.Empty value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $3.MultiProfilesResponse.fromBuffer(value));
  static final _$getActiveProfile = $grpc.ClientMethod<$1.Empty, $3.ProfileResponse>(
      '/profile.ProfileService/GetActiveProfile',
      ($1.Empty value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $3.ProfileResponse.fromBuffer(value));
  static final _$setActiveProfile = $grpc.ClientMethod<$3.ProfileRequest, $1.Response>(
      '/profile.ProfileService/SetActiveProfile',
      ($3.ProfileRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $1.Response.fromBuffer(value));
  static final _$addProfile = $grpc.ClientMethod<$3.AddProfileRequest, $3.ProfileResponse>(
      '/profile.ProfileService/AddProfile',
      ($3.AddProfileRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $3.ProfileResponse.fromBuffer(value));
  static final _$deleteProfile = $grpc.ClientMethod<$3.ProfileRequest, $1.Response>(
  ...
  $grpc.ResponseFuture<$3.ProfileResponse> getProfile($3.ProfileRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getProfile, request, options: options);
  }

  $grpc.ResponseFuture<$3.ProfileResponse> updateProfile($4.ProfileEntity request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$updateProfile, request, options: options);
  }

  $grpc.ResponseFuture<$3.MultiProfilesResponse> getAllProfiles($1.Empty request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getAllProfiles, request, options: options);
  }

  $grpc.ResponseFuture<$3.ProfileResponse> getActiveProfile($1.Empty request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getActiveProfile, request, options: options);
  }

  $grpc.ResponseFuture<$1.Response> setActiveProfile($3.ProfileRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$setActiveProfile, request, options: options);
  }

  $grpc.ResponseFuture<$3.ProfileResponse> addProfile($3.AddProfileRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$addProfile, request, options: options);
  }

  $grpc.ResponseFuture<$1.Response> deleteProfile($3.ProfileRequest request, {$grpc.CallOptions? options}) {
...
abstract class ProfileServiceBase extends $grpc.Service {
  ...
  $async.Future<$3.ProfileResponse> addProfile_Pre(
      $grpc.ServiceCall call, $async.Future<$3.AddProfileRequest> request) async {
    return addProfile(call, await request);
  }

  $async.Future<$1.Response> deleteProfile_Pre($grpc.ServiceCall call, $async.Future<$3.ProfileRequest> request) async {
    return deleteProfile(call, await request);
  }

  $async.Future<$3.ProfileResponse> getProfile($grpc.ServiceCall call, $3.ProfileRequest request);
  $async.Future<$3.ProfileResponse> updateProfile($grpc.ServiceCall call, $4.ProfileEntity request);
  $async.Future<$3.MultiProfilesResponse> getAllProfiles($grpc.ServiceCall call, $1.Empty request);
  $async.Future<$3.ProfileResponse> getActiveProfile($grpc.ServiceCall call, $1.Empty request);
  $async.Future<$1.Response> setActiveProfile($grpc.ServiceCall call, $3.ProfileRequest request);
  $async.Future<$3.ProfileResponse> addProfile($grpc.ServiceCall call, $3.AddProfileRequest request);
  $async.Future<$1.Response> deleteProfile($grpc.ServiceCall call, $3.ProfileRequest request);
}
