...
abstract class _$PerAppProxy
    extends BuildlessAutoDisposeStreamNotifier<Map<String, int>> {
...
class PerAppProxyFamily extends Family<AsyncValue<Map<String, int>>> {
  ...
  @override
  PerAppProxyProvider getProviderOverride(
    covariant PerAppProxyProvider provider,
  ) {
...
/// See also [PerAppProxy].
class PerAppProxyProvider
    extends
        AutoDisposeStreamNotifierProviderImpl<PerAppProxy, Map<String, int>> {
  /// See also [PerAppProxy].
  ...
  @override
  AutoDisposeStreamNotifierProviderElement<PerAppProxy, Map<String, int>>
  createElement() {
...
class _PerAppProxyProviderElement
    extends
        AutoDisposeStreamNotifierProviderElement<PerAppProxy, Map<String, int>>
    with PerAppProxyRef {
