...
mixin _$ProfileEntity {
  ...
  Map<String, dynamic>? get populatedHeaders =>
      throw _privateConstructorUsedError;
  String? get profileOverride => throw _privateConstructorUsedError;
  UserOverride? get userOverride => throw _privateConstructorUsedError;
  @optionalTypeArgs
...
abstract class $ProfileEntityCopyWith<$Res> {
  ...
  $UserOverrideCopyWith<$Res>? get userOverride;
}
...
class _$ProfileEntityCopyWithImpl<$Res, $Val extends ProfileEntity>
  ...
  $Res call({
    ...
    Object? populatedHeaders = freezed,
    Object? profileOverride = freezed,
      ...
      _value.copyWith(
            ...
            lastUpdate: null == lastUpdate
                ...
                : lastUpdate // ignore: cast_nullable_to_non_nullable
                      as DateTime,
            populatedHeaders: freezed == populatedHeaders
                ? _value.populatedHeaders
                : populatedHeaders // ignore: cast_nullable_to_non_nullable
                      as Map<String, dynamic>?,
            profileOverride: freezed == profileOverride
                ? _value.profileOverride
                : profileOverride // ignore: cast_nullable_to_non_nullable
                      as String?,
  ...
  @pragma('vm:prefer-inline')
  $UserOverrideCopyWith<$Res>? get userOverride {
    if (_value.userOverride == null) {
      return null;
    }

    return $UserOverrideCopyWith<$Res>(_value.userOverride!, (value) {
      return _then(_value.copyWith(userOverride: value) as $Val);
    });
  }
}
...
abstract class _$$RemoteProfileEntityImplCopyWith<$Res>
    implements $ProfileEntityCopyWith<$Res> {
  factory _$$RemoteProfileEntityImplCopyWith(
    _$RemoteProfileEntityImpl value,
...
class __$$RemoteProfileEntityImplCopyWithImpl<$Res>
  ...
  __$$RemoteProfileEntityImplCopyWithImpl(
    _$RemoteProfileEntityImpl _value,
...
class _$RemoteProfileEntityImpl extends RemoteProfileEntity {
  const _$RemoteProfileEntityImpl({
    ...
    this.options,
    this.subInfo,
    final Map<String, dynamic>? populatedHeaders,
    this.profileOverride,
    this.userOverride,
  }) : _populatedHeaders = populatedHeaders,
       super._();
  ...
  final Map<String, dynamic>? _populatedHeaders;
  @override
  Map<String, dynamic>? get populatedHeaders {
    final value = _populatedHeaders;
    if (value == null) return null;
    if (_populatedHeaders is EqualUnmodifiableMapView) return _populatedHeaders;
  ...
  @override
  final UserOverride? userOverride;

  @override
  String toString() {
    return 'ProfileEntity.remote(id: $id, active: $active, name: $name, url: $url, lastUpdate: $lastUpdate, options: $options, subInfo: $subInfo, populatedHeaders: $populatedHeaders, profileOverride: $profileOverride, userOverride: $userOverride)';
  }
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality().equals(
              other._populatedHeaders,
              _populatedHeaders,
            ) &&
            (identical(other.profileOverride, profileOverride) ||
                other.profileOverride == profileOverride) &&
  ...
  int get hashCode => Object.hash(
    ...
    options,
    subInfo,
    const DeepCollectionEquality().hash(_populatedHeaders),
    profileOverride,
    userOverride,
  );
...
abstract class _$$LocalProfileEntityImplCopyWith<$Res>
    implements $ProfileEntityCopyWith<$Res> {
  factory _$$LocalProfileEntityImplCopyWith(
    _$LocalProfileEntityImpl value,
...
class __$$LocalProfileEntityImplCopyWithImpl<$Res>
  ...
  __$$LocalProfileEntityImplCopyWithImpl(
    _$LocalProfileEntityImpl _value,
...
class _$LocalProfileEntityImpl extends LocalProfileEntity {
  ...
  @override
  String toString() {
    return 'ProfileEntity.local(id: $id, active: $active, name: $name, lastUpdate: $lastUpdate, populatedHeaders: $populatedHeaders, profileOverride: $profileOverride, userOverride: $userOverride)';
  }
...
class _$ProfileOptionsCopyWithImpl<$Res, $Val extends ProfileOptions>
  ...
  @pragma('vm:prefer-inline')
  @override
  $Res call({Object? updateInterval = null}) {
    return _then(
      _value.copyWith(
...
class _$ProfileOptionsImpl implements _ProfileOptions {
  const _$ProfileOptionsImpl({this.updateInterval = Duration.zero});
...
abstract class _ProfileOptions implements ProfileOptions {
  const factory _ProfileOptions({final Duration updateInterval}) =
      _$ProfileOptionsImpl;
...
UserOverride _$UserOverrideFromJson(Map<String, dynamic> json) {
  return _UserOverride.fromJson(json);
}

/// @nodoc
mixin _$UserOverride {
  int get version => throw _privateConstructorUsedError;
  String? get name => throw _privateConstructorUsedError;
  bool get isAutoUpdateDisable => throw _privateConstructorUsedError; // hours
  int? get updateInterval => throw _privateConstructorUsedError;
  bool? get enableWarp => throw _privateConstructorUsedError;
  bool? get enableFragment => throw _privateConstructorUsedError;

  /// Serializes this UserOverride to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of UserOverride
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $UserOverrideCopyWith<UserOverride> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $UserOverrideCopyWith<$Res> {
  factory $UserOverrideCopyWith(
    UserOverride value,
    $Res Function(UserOverride) then,
  ) = _$UserOverrideCopyWithImpl<$Res, UserOverride>;
  @useResult
  $Res call({
    int version,
    String? name,
    bool isAutoUpdateDisable,
    int? updateInterval,
    bool? enableWarp,
    bool? enableFragment,
  });
...
/// @nodoc
class _$UserOverrideCopyWithImpl<$Res, $Val extends UserOverride>
    implements $UserOverrideCopyWith<$Res> {
  _$UserOverrideCopyWithImpl(this._value, this._then);
  ...
  $Res call({
    Object? version = null,
    Object? name = freezed,
    Object? isAutoUpdateDisable = null,
    Object? updateInterval = freezed,
    Object? enableWarp = freezed,
    Object? enableFragment = freezed,
  }) {
    return _then(
      _value.copyWith(
            ...
            name: freezed == name
                ...
                : name // ignore: cast_nullable_to_non_nullable
                      as String?,
            isAutoUpdateDisable: null == isAutoUpdateDisable
                ? _value.isAutoUpdateDisable
                : isAutoUpdateDisable // ignore: cast_nullable_to_non_nullable
                      as bool,
            updateInterval: freezed == updateInterval
                ? _value.updateInterval
                : updateInterval // ignore: cast_nullable_to_non_nullable
                      as int?,
            enableWarp: freezed == enableWarp
                ? _value.enableWarp
                : enableWarp // ignore: cast_nullable_to_non_nullable
                      as bool?,
            enableFragment: freezed == enableFragment
...
/// @nodoc
abstract class _$$UserOverrideImplCopyWith<$Res>
    implements $UserOverrideCopyWith<$Res> {
  factory _$$UserOverrideImplCopyWith(
    _$UserOverrideImpl value,
    $Res Function(_$UserOverrideImpl) then,
  ) = __$$UserOverrideImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({
    int version,
...
/// @nodoc
class __$$UserOverrideImplCopyWithImpl<$Res>
    extends _$UserOverrideCopyWithImpl<$Res, _$UserOverrideImpl>
    implements _$$UserOverrideImplCopyWith<$Res> {
  __$$UserOverrideImplCopyWithImpl(
    _$UserOverrideImpl _value,
    $Res Function(_$UserOverrideImpl) _then,
  ) : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$UserOverrideImpl extends _UserOverride {
  const _$UserOverrideImpl({
    this.version = latestUserOverrideVersion,
    this.name,
    this.isAutoUpdateDisable = false,
    this.updateInterval,
    this.enableWarp,
    this.enableFragment,
  }) : super._();

  factory _$UserOverrideImpl.fromJson(Map<String, dynamic> json) =>
      _$$UserOverrideImplFromJson(json);
  ...
  @override
  @JsonKey()
  final bool isAutoUpdateDisable;
  // hours
  @override
  ...
  @override
  String toString() {
    return 'UserOverride(version: $version, name: $name, isAutoUpdateDisable: $isAutoUpdateDisable, updateInterval: $updateInterval, enableWarp: $enableWarp, enableFragment: $enableFragment)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$UserOverrideImpl &&
            (identical(other.version, version) || other.version == version) &&
            (identical(other.name, name) || other.name == name) &&
            (identical(other.isAutoUpdateDisable, isAutoUpdateDisable) ||
                other.isAutoUpdateDisable == isAutoUpdateDisable) &&
            (identical(other.updateInterval, updateInterval) ||
                other.updateInterval == updateInterval) &&
            (identical(other.enableWarp, enableWarp) ||
                other.enableWarp == enableWarp) &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$UserOverrideImplCopyWith<_$UserOverrideImpl> get copyWith =>
      __$$UserOverrideImplCopyWithImpl<_$UserOverrideImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$UserOverrideImplToJson(this);
  }
}

abstract class _UserOverride extends UserOverride {
  const factory _UserOverride({
    final int version,
    final String? name,
    final bool isAutoUpdateDisable,
    final int? updateInterval,
  ...
  const _UserOverride._() : super._();

  factory _UserOverride.fromJson(Map<String, dynamic> json) =
      _$UserOverrideImpl.fromJson;
  ...
  String? get name;
  @override
  bool get isAutoUpdateDisable; // hours
  @override
