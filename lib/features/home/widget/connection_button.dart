        ...
        Semantics(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [BoxShadow(blurRadius: 24, spreadRadius: -2, color: buttonColor.withValues(alpha: .6))],
            ),
            width: 148,
            height: 148,
            child: Material(
              ...
              child: InkWell(
                ...
                child: Container(
                  decoration: BoxDecoration(
                    shape: BoxShape.circle,
                    border: Border.all(color: buttonColor.withValues(alpha: 0.5), width: 2),
                  ),
                  ...
                  child: TweenAnimationBuilder(
                    ...
                    builder: (context, value, child) {
                      if (useImage) {
                        ...
                        return Icon(Icons.shield_outlined, size: 64, color: value);
                      }
                    },
                  ),
                ),
          ...
          ).animate(target: enabled ? 0 : 1).scaleXY(end: .88, curve: Curves.easeIn).blurXY(end: 1),
        ),
        const Gap(16),
        ExcludeSemantics(
          child: Column(
