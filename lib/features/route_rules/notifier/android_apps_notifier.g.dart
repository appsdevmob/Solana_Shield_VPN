...
final appsHideSystemProvider =
    AutoDisposeFutureProvider<List<AppInfo>>.internal(
      appsHideSystem,
      name: r'appsHideSystemProvider',
      debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
          ? null
          : _$appsHideSystemHash,
      dependencies: null,
      allTransitiveDependencies: null,
    );
...
String _$filteredByHideSystemHash() =>
    r'0dff016e976939289471c2d9641f412b099c27bd';

/// See also [filteredByHideSystem].
@ProviderFor(filteredByHideSystem)
final filteredByHideSystemProvider =
    AutoDisposeFutureProvider<List<AppInfo>>.internal(
      filteredByHideSystem,
      name: r'filteredByHideSystemProvider',
      debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
          ? null
          : _$filteredByHideSystemHash,
      dependencies: null,
      allTransitiveDependencies: null,
    );
...
String _$uninstalledPackagesHash() =>
    r'6fb77101952710ce37f43867bd04a8a43d210db5';
...
class UninstalledPackagesFamily extends Family<AsyncValue<List<String>>> {
  ...
  @override
  UninstalledPackagesProvider getProviderOverride(
    covariant UninstalledPackagesProvider provider,
  ) {
...
class UninstalledPackagesProvider
  ...
  Override overrideWith(
    FutureOr<List<String>> Function(UninstalledPackagesRef provider) create,
  ) {
  ...
  bool operator ==(Object other) {
    return other is UninstalledPackagesProvider &&
        other.ruleListOrder == ruleListOrder;
  }
...
class _UninstalledPackagesProviderElement
  ...
  @override
  int? get ruleListOrder =>
      (origin as UninstalledPackagesProvider).ruleListOrder;
}
...
class FilterBySearchFamily extends Family<AsyncValue<List<dynamic>>> {
  ...
  @override
  FilterBySearchProvider getProviderOverride(
    covariant FilterBySearchProvider provider,
  ) {
    return call(provider.ruleListOrder);
  }
...
class FilterBySearchProvider extends AutoDisposeFutureProvider<List<dynamic>> {
  ...
  FilterBySearchProvider(int? ruleListOrder)
    : this._internal(
        ...
        debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
            ? null
            : _$filterBySearchHash,
        dependencies: FilterBySearchFamily._dependencies,
        allTransitiveDependencies:
            FilterBySearchFamily._allTransitiveDependencies,
        ruleListOrder: ruleListOrder,
      );
  ...
  @override
  Override overrideWith(
    FutureOr<List<dynamic>> Function(FilterBySearchRef provider) create,
  ) {
    return ProviderOverride(
      origin: this,
  ...
  @override
  bool operator ==(Object other) {
    return other is FilterBySearchProvider &&
        other.ruleListOrder == ruleListOrder;
  }
...
class _FilterBySearchProviderElement
    extends AutoDisposeFutureProviderElement<List<dynamic>>
    with FilterBySearchRef {
...
String _$hideSystemNotifierHash() =>
    r'750b63c456d56b8b9befbb89587690866e7ac02e';

/// See also [HideSystemNotifier].
@ProviderFor(HideSystemNotifier)
final hideSystemNotifierProvider =
    AutoDisposeNotifierProvider<HideSystemNotifier, bool>.internal(
      HideSystemNotifier.new,
      name: r'hideSystemNotifierProvider',
      debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
          ? null
          : _$hideSystemNotifierHash,
      dependencies: null,
      allTransitiveDependencies: null,
    );
...
String _$searchQueryNotifierHash() =>
    r'37ee601e1130ad8f72c1acd630a8e4baf09fb676';
...
String _$selectedPackagesNotifierHash() =>
    r'a4ca5f8f1064d0b2fdb553283984df54f3b6a142';

abstract class _$SelectedPackagesNotifier
...
class SelectedPackagesNotifierFamily extends Family<List<String>> {
  ...
  @override
  SelectedPackagesNotifierProvider getProviderOverride(
    covariant SelectedPackagesNotifierProvider provider,
  ) {
    return call(provider.ruleListOrder);
  }
...
/// See also [SelectedPackagesNotifier].
class SelectedPackagesNotifierProvider
    extends
  ...
  SelectedPackagesNotifierProvider(int? ruleListOrder)
    : this._internal(
        ...
        debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
            ? null
            : _$selectedPackagesNotifierHash,
        dependencies: SelectedPackagesNotifierFamily._dependencies,
        allTransitiveDependencies:
            SelectedPackagesNotifierFamily._allTransitiveDependencies,
        ruleListOrder: ruleListOrder,
      );
  ...
  @override
  AutoDisposeNotifierProviderElement<SelectedPackagesNotifier, List<String>>
  createElement() {
  ...
  @override
  bool operator ==(Object other) {
    return other is SelectedPackagesNotifierProvider &&
        other.ruleListOrder == ruleListOrder;
  }
...
@Deprecated('Will be removed in 3.0. Use Ref instead')
// ignore: unused_element
mixin SelectedPackagesNotifierRef
...
class _SelectedPackagesNotifierProviderElement
  ...
  @override
  int? get ruleListOrder =>
      (origin as SelectedPackagesNotifierProvider).ruleListOrder;
}
