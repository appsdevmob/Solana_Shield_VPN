...
/// Секция кошелька Solana в настройках
class _SolanaWalletSection extends ConsumerWidget {
  @override
  Widget build(BuildContext context, WidgetRef ref) {
            ...
            children: [
              Row(
                children: [
                  ...
                  const Gap(12),
                  Text(t.walletSection.title, style: theme.textTheme.titleMedium),
                ],
              ),
              const Gap(12),
              Row(
                children: [
                  ...
                  IconButton(
                    ...
                    tooltip: t.walletSection.copyAddress,
                    onPressed: () {
                      Clipboard.setData(ClipboardData(text: address));
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(
                          content: Text(t.walletSection.addressCopied),
              ...
              SizedBox(
                ...
                child: OutlinedButton.icon(
                  ...
                  label: Text(t.walletSection.logout),
                  ...
                  onPressed: () async {
                    await SolanaAuthService.instance.logout();
                    if (context.mounted) {
                      ref.read(solanaIsAuthenticatedProvider.notifier).state = false;
                      context.goNamed('solana-auth');
                    }
                  },
                ),
              ),
