...
class TranslationsId extends Translations {
	...
	@override late final TranslationsSolanaAuthId solanaAuth = TranslationsSolanaAuthId._(_root);
	@override late final TranslationsWalletSectionId walletSection = TranslationsWalletSectionId._(_root);
}
...
// Path: solanaAuth
class TranslationsSolanaAuthId extends TranslationsSolanaAuthEn {
	TranslationsSolanaAuthId._(TranslationsId root) : this._root = root, super.internal(root);

	final TranslationsId _root; // ignore: unused_field

	// Translations
	@override String get title => 'VPN Solana';
	@override String get subtitle => 'VPN aman di blockchain Solana';
	@override String get connecting => 'Menghubungkan...';
	@override String get openWallet => 'Buka dompet untuk mengonfirmasi';
	@override String get tryAgain => 'Coba lagi';
	@override String get loginWithSolana => 'Masuk dengan Solana';
	@override String get supportedWallets => 'Phantom • Solflare • Trust Wallet';
	@override String get infoCard => 'Data Anda tetap pribadi. Tanpa kata sandi — hanya dompet Anda.';
	@override String get HiddifyCore => 'Solana Shield VPN';
	@override late final TranslationsSolanaAuthErrorsId errors = TranslationsSolanaAuthErrorsId._(_root);
}

// Path: walletSection
class TranslationsWalletSectionId extends TranslationsWalletSectionEn {
	TranslationsWalletSectionId._(TranslationsId root) : this._root = root, super.internal(root);

	final TranslationsId _root; // ignore: unused_field

	// Translations
	@override String get title => 'Dompet Solana';
	@override String get addressCopied => 'Alamat disalin';
	@override String get logout => 'Keluar';
	@override String get copyAddress => 'Salin alamat';
}
...
class TranslationsSolanaAuthErrorsId extends TranslationsSolanaAuthErrorsEn {
	TranslationsSolanaAuthErrorsId._(TranslationsId root) : this._root = root, super.internal(root);

	final TranslationsId _root; // ignore: unused_field

	// Translations
	@override String get cancelled => 'Koneksi dibatalkan. Coba lagi.';
	@override String get timeout => 'Waktu habis. Pastikan dompet sudah diinstal.';
	@override String get notFound => 'Dompet Solana tidak ditemukan. Instal Phantom atau Solflare.';
	@override String get channelError => 'Kesalahan komunikasi dompet. Mulai ulang aplikasi.';
	@override String get unknown => 'Gagal terhubung';
	@override String get rawPrefix => 'Kesalahan: ';
}
...
extension on TranslationsId {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'pages.home.quickSettings': return 'Pengaturan cepat';
			...
			case 'pages.settings.routing.perAppProxy.title': return 'Proxy per aplikasi';
			case 'pages.settings.routing.perAppProxy.hideSysApps': return 'Sembunyikan aplikasi sistem';
			case 'pages.settings.routing.perAppProxy.options.import.clipboard': return 'Impor pilihan dari papan klip';
			case 'pages.settings.routing.perAppProxy.options.import.file': return 'Impor pilihan dari file';
			case 'pages.settings.routing.perAppProxy.options.import.msg': return 'Mengimpor akan menggantikan pilihan Anda saat ini. Anda yakin ingin melanjutkan?';
			case 'pages.settings.routing.perAppProxy.options.export.clipboard': return 'Salin pilihan ke papan klip';
			case 'pages.settings.routing.perAppProxy.options.export.file': return 'Ekspor pilihan ke file';
			case 'pages.settings.routing.perAppProxy.options.shareToAll': return 'Bagikan ke semua';
			case 'pages.settings.routing.perAppProxy.options.clearAllSelections': return 'Hapus semua pilihan';
			case 'pages.settings.routing.perAppProxy.modes.all': return 'Semua';
			case 'pages.settings.routing.perAppProxy.modes.proxy': return 'Proxy';
			case 'pages.settings.routing.perAppProxy.modes.bypass': return 'Lewati';
			case 'pages.settings.routing.perAppProxy.modes.allMsg': return 'Proxy semua aplikasi';
			case 'pages.settings.routing.perAppProxy.modes.proxyMsg': return 'Proxy hanya aplikasi yang dipilih';
			case 'pages.settings.routing.perAppProxy.modes.bypassMsg': return 'Jangan proxy aplikasi yang dipilih';
			case 'pages.settings.routing.perAppProxy.autoSelection.title': return 'Pilihan otomatis';
			case 'pages.settings.routing.perAppProxy.autoSelection.performNow': return 'Lakukan sekarang';
			case 'pages.settings.routing.perAppProxy.autoSelection.resetToDefault': return 'Setel ulang ke default';
			case 'pages.settings.routing.perAppProxy.autoSelection.autoUpdateInterval': return 'Interval pembaruan otomatis';
			case 'pages.settings.routing.perAppProxy.autoSelection.toast.success': return 'Pilihan aplikasi otomatis berhasil diselesaikan';
			case 'pages.settings.routing.perAppProxy.autoSelection.toast.failure': return 'Pilihan otomatis gagal';
			case 'pages.settings.routing.perAppProxy.autoSelection.toast.regionNotFound': return ({required Object region}) => 'Pilihan otomatis tidak ditemukan untuk wilayah "${region}"';
			case 'pages.settings.routing.perAppProxy.autoSelection.toast.alreadyInAuto': return 'Pilihan Anda sudah ada dalam daftar otomatis';
			case 'pages.settings.routing.perAppProxy.autoSelection.dialog.title': return 'Pilihan aplikasi otomatis';
			case 'pages.settings.routing.perAppProxy.autoSelection.dialog.msg': return ({required Object region}) => 'Fitur pilihan otomatis untuk proxy per aplikasi dinonaktifkan karena perubahan wilayah menjadi "${region}"';
			case 'pages.settings.routing.region': return 'Wilayah';
			case 'pages.settings.routing.regions.ir': return 'Iran (ir) 🇮🇷';
			case 'pages.settings.routing.regions.cn': return 'Tiongkok (cn) 🇨🇳';
			...
			case 'pages.settings.routing.regions.tr': return 'Turki (tr) 🇹🇷';
			case 'pages.settings.routing.regions.br': return 'Brasil (br) 🇧🇷';
			case 'pages.settings.routing.regions.other': return 'Lainnya';
			case 'pages.settings.routing.balancerStrategy.title': return 'Strategi Balancer';
			...
			case 'pages.settings.routing.blockAds': return 'Blokir iklan';
			case 'pages.settings.routing.bypassLan': return 'Lewati LAN';
			case 'pages.settings.routing.resolveDestination': return 'Resolusi tujuan';
			case 'pages.settings.routing.ipv6Route': return 'Rute IPv6';
			case 'pages.settings.routing.ipv6Modes.disable': return 'Nonaktifkan';
			case 'pages.settings.routing.ipv6Modes.enable': return 'Aktifkan';
			case 'pages.settings.routing.ipv6Modes.prefer': return 'Prioritaskan';
			case 'pages.settings.routing.ipv6Modes.only': return 'Hanya';
			case 'pages.settings.routing.routeRule.title': return 'Aturan perutean';
			...
			case 'pages.settings.routing.routeRule.deleteRule': return 'Hapus aturan';
			case 'pages.settings.routing.routeRule.createRule': return 'Buat aturan baru';
			case 'pages.settings.routing.routeRule.rule.title': return 'Aturan';
			case 'pages.settings.routing.routeRule.rule.ruleChanged': return 'Aturan diubah';
			case 'pages.settings.routing.routeRule.rule.ruleChangedMsg': return 'Apakah Anda ingin menyimpan editan Anda?';
			...
			case 'pages.settings.routing.routeRule.androidApps.pageTitle': return 'Aplikasi Android';
			case 'pages.settings.routing.routeRule.androidApps.showSystemApps': return 'Tampilkan aplikasi sistem';
			case 'pages.settings.routing.routeRule.androidApps.hideSystemApps': return 'Sembunyikan aplikasi sistem';
			case 'pages.settings.routing.routeRule.androidApps.clearSelection': return 'Hapus pilihan';
			case 'pages.settings.routing.routeRule.androidApps.uninstalled': return 'Dihapus';
			...
			case 'pages.settings.dns.enableDnsRouting': return 'Aktifkan perutean DNS';
			...
			case 'pages.settings.inbound.serviceModes.tunService': return 'Layanan VPN';
			...
			case 'pages.settings.inbound.shortServiceModes.tunService': return 'Layanan VPN';
			...
			case 'pages.settings.inbound.allowConnectionFromLan': return 'Bagikan VPN di jaringan lokal';
			...
			case 'pages.settings.warp.enable': return 'Aktifkan WARP';
			case 'pages.settings.warp.generateConfig': return 'Buat konfigurasi WARP';
			case 'pages.settings.warp.configGenerated': return 'Konfigurasi WARP dibuat';
			case 'pages.settings.warp.missingConfig': return 'Konfigurasi WARP hilang';
			case 'pages.settings.warp.detourMode': return 'Mode Rute WARP';
			case 'pages.settings.warp.detourModes.proxyOverWarp': return 'Alihkan proksi melalui WARP';
			case 'pages.settings.warp.detourModes.warpOverProxy': return 'Alihkan WARP melalui proksi';
			case 'pages.settings.warp.detourModes.proxyOverWarpExplain': return 'Buka blokir proksi dengan WARP';
			case 'pages.settings.warp.detourModes.warpOverProxyExplain': return 'Keamanan ekstra dengan WARP';
			case 'pages.settings.warp.licenseKey': return 'Kunci lisensi';
			case 'pages.settings.warp.cleanIp': return 'IP bersih';
			case 'pages.settings.warp.port': return 'Port';
			case 'pages.settings.warp.noise.count': return 'Jumlah kebisingan';
			case 'pages.settings.warp.noise.mode': return 'Mode kebisingan';
			case 'pages.settings.warp.noise.size': return 'Ukuran kebisingan';
			case 'pages.settings.warp.noise.delay': return 'Penundaan kebisingan';
			...
			case 'connection.secure': return 'Diamankan oleh WARP';
			...
			case 'solanaAuth.subtitle': return 'VPN aman di blockchain Solana';
			case 'solanaAuth.connecting': return 'Menghubungkan...';
			case 'solanaAuth.openWallet': return 'Buka dompet untuk mengonfirmasi';
			case 'solanaAuth.tryAgain': return 'Coba lagi';
			case 'solanaAuth.loginWithSolana': return 'Masuk dengan Solana';
			case 'solanaAuth.supportedWallets': return 'Phantom • Solflare • Trust Wallet';
			case 'solanaAuth.infoCard': return 'Data Anda tetap pribadi. Tanpa kata sandi — hanya dompet Anda.';
			case 'solanaAuth.HiddifyCore': return 'Solana Shield VPN';
			case 'solanaAuth.errors.cancelled': return 'Koneksi dibatalkan. Coba lagi.';
			case 'solanaAuth.errors.timeout': return 'Waktu habis. Pastikan dompet sudah diinstal.';
			case 'solanaAuth.errors.notFound': return 'Dompet Solana tidak ditemukan. Instal Phantom atau Solflare.';
			case 'solanaAuth.errors.channelError': return 'Kesalahan komunikasi dompet. Mulai ulang aplikasi.';
			case 'solanaAuth.errors.unknown': return 'Gagal terhubung';
			case 'solanaAuth.errors.rawPrefix': return 'Kesalahan: ';
			case 'walletSection.title': return 'Dompet Solana';
			case 'walletSection.addressCopied': return 'Alamat disalin';
			case 'walletSection.logout': return 'Keluar';
			case 'walletSection.copyAddress': return 'Salin alamat';
			default: return null;
		}
	}
}
