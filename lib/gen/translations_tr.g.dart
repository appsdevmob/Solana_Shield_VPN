...
class TranslationsTr extends Translations {
	...
	@override late final TranslationsSolanaAuthTr solanaAuth = TranslationsSolanaAuthTr._(_root);
	@override late final TranslationsWalletSectionTr walletSection = TranslationsWalletSectionTr._(_root);
}
...
class TranslationsConnectionTr extends TranslationsConnectionEn {
	...
	@override String get secure => 'WARP ile güvende';
}
...
// Path: solanaAuth
class TranslationsSolanaAuthTr extends TranslationsSolanaAuthEn {
	TranslationsSolanaAuthTr._(TranslationsTr root) : this._root = root, super.internal(root);

	final TranslationsTr _root; // ignore: unused_field

	// Translations
	@override String get title => 'VPN Solana';
	@override String get subtitle => 'Solana blok zincirinde güvenli VPN';
	@override String get connecting => 'Bağlanıyor...';
	@override String get openWallet => 'Onaylamak için cüzdanı açın';
	@override String get tryAgain => 'Tekrar dene';
	@override String get loginWithSolana => 'Solana ile Giriş Yap';
	@override String get supportedWallets => 'Phantom • Solflare • Trust Wallet';
	@override String get infoCard => 'Verileriniz gizli kalır. Şifre yok — sadece cüzdanınız.';
	@override String get HiddifyCore => 'Solana Shield VPN';
	@override late final TranslationsSolanaAuthErrorsTr errors = TranslationsSolanaAuthErrorsTr._(_root);
}

// Path: walletSection
class TranslationsWalletSectionTr extends TranslationsWalletSectionEn {
	TranslationsWalletSectionTr._(TranslationsTr root) : this._root = root, super.internal(root);

	final TranslationsTr _root; // ignore: unused_field

	// Translations
	@override String get title => 'Solana Cüzdanı';
	@override String get addressCopied => 'Adres kopyalandı';
	@override String get logout => 'Çıkış Yap';
	@override String get copyAddress => 'Adresi Kopyala';
}
...
class TranslationsErrorsWarpTr extends TranslationsErrorsWarpEn {
	...
	// Translations
	@override String get missingLicense => 'WARP lisansı eksik';
...
class TranslationsSolanaAuthErrorsTr extends TranslationsSolanaAuthErrorsEn {
	TranslationsSolanaAuthErrorsTr._(TranslationsTr root) : this._root = root, super.internal(root);

	final TranslationsTr _root; // ignore: unused_field

	// Translations
	@override String get cancelled => 'Bağlantı iptal edildi. Tekrar dene.';
	@override String get timeout => 'Zaman aşımı. Cüzdanın kurulu olduğundan emin olun.';
	@override String get notFound => 'Solana cüzdanı bulunamadı. Phantom veya Solflare yükleyin.';
	@override String get channelError => 'Cüzdan iletişim hatası. Uygulamayı yeniden başlatın.';
	@override String get unknown => 'Bağlantı başarısız';
	@override String get rawPrefix => 'Hata: ';
}
...
class TranslationsPagesSettingsDnsTr extends TranslationsPagesSettingsDnsEn {
	...
	@override String get enableDnsRouting => 'DNS yönlendirmeyi etkinleştir';
...
class TranslationsPagesSettingsInboundTr extends TranslationsPagesSettingsInboundEn {
	...
	@override String get allowConnectionFromLan => 'VPN\'i yerel ağda paylaş';
}
...
class TranslationsPagesSettingsWarpTr extends TranslationsPagesSettingsWarpEn {
	...
	@override String get enable => 'WARP\'ı etkinleştir';
	@override String get generateConfig => 'WARP yapılandırması oluştur';
	@override String get configGenerated => 'WARP yapılandırması oluşturuldu';
	@override String get missingConfig => 'WARP yapılandırması eksik';
	@override String get detourMode => 'Yönlendirme modu';
...
class TranslationsPagesSettingsRoutingRouteRuleTr extends TranslationsPagesSettingsRoutingRouteRuleEn {
	...
	@override String get createRule => 'Yeni kural oluştur';
...
class TranslationsPagesSettingsWarpDetourModesTr extends TranslationsPagesSettingsWarpDetourModesEn {
	...
	// Translations
	@override String get proxyOverWarp => 'Proxy\'leri WARP üzerinden yönlendir';
	@override String get warpOverProxy => 'WARP\'ı proxy\'ler üzerinden yönlendir';
	@override String get proxyOverWarpExplain => 'Proxy\'lerin engelini WARP ile kaldır';
	@override String get warpOverProxyExplain => 'WARP ile ekstra güvenlik';
}
...
class TranslationsPagesSettingsRoutingRouteRuleRuleTr extends TranslationsPagesSettingsRoutingRouteRuleRuleEn {
	...
	@override String get ruleChanged => 'Kural değiştirildi';
	@override String get ruleChangedMsg => 'Düzenlemelerinizi kaydetmek istiyor musunuz?';
...
class TranslationsPagesSettingsRoutingRouteRuleAndroidAppsTr extends TranslationsPagesSettingsRoutingRouteRuleAndroidAppsEn {
	...
	// Translations
	@override String get pageTitle => 'Android uygulamaları';
	...
	@override String get uninstalled => 'Kaldırıldı';
}
...
extension on TranslationsTr {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'pages.home.quickSettings': return 'Hızlı ayarlar';
			...
			case 'pages.settings.general.memoryLimit': return 'Bellek limiti';
			...
			case 'pages.settings.routing.perAppProxy.title': return 'Uygulama bazlı proxy';
			case 'pages.settings.routing.perAppProxy.hideSysApps': return 'Sistem uygulamalarını gizle';
			case 'pages.settings.routing.perAppProxy.options.import.clipboard': return 'Seçimi panodan içe aktar';
			case 'pages.settings.routing.perAppProxy.options.import.file': return 'Seçimi dosyadan içe aktar';
			case 'pages.settings.routing.perAppProxy.options.import.msg': return 'İçe aktarma mevcut seçimlerinizin üzerine yazacaktır. Devam etmek istediğinizden emin misiniz?';
			case 'pages.settings.routing.perAppProxy.options.export.clipboard': return 'Seçimi panoya kopyala';
			case 'pages.settings.routing.perAppProxy.options.export.file': return 'Seçimi dosyaya aktar';
			case 'pages.settings.routing.perAppProxy.options.shareToAll': return 'Herkesle paylaş';
			case 'pages.settings.routing.perAppProxy.options.clearAllSelections': return 'Tüm seçimleri temizle';
			case 'pages.settings.routing.perAppProxy.modes.all': return 'Tümü';
			case 'pages.settings.routing.perAppProxy.modes.proxy': return 'Proxy';
			case 'pages.settings.routing.perAppProxy.modes.bypass': return 'Atla';
			case 'pages.settings.routing.perAppProxy.modes.allMsg': return 'Tüm uygulamaları proxy\'le';
			case 'pages.settings.routing.perAppProxy.modes.proxyMsg': return 'Yalnızca seçili uygulamaları proxy\'le';
			case 'pages.settings.routing.perAppProxy.modes.bypassMsg': return 'Seçili uygulamaları proxy\'leme';
			case 'pages.settings.routing.perAppProxy.autoSelection.title': return 'Otomatik seçim';
			case 'pages.settings.routing.perAppProxy.autoSelection.performNow': return 'Şimdi gerçekleştir';
			case 'pages.settings.routing.perAppProxy.autoSelection.resetToDefault': return 'Varsayılana sıfırla';
			case 'pages.settings.routing.perAppProxy.autoSelection.autoUpdateInterval': return 'Otomatik güncelleme aralığı';
			case 'pages.settings.routing.perAppProxy.autoSelection.toast.success': return 'Otomatik uygulama seçimi başarıyla tamamlandı';
			case 'pages.settings.routing.perAppProxy.autoSelection.toast.failure': return 'Otomatik seçim başarısız oldu';
			case 'pages.settings.routing.perAppProxy.autoSelection.toast.regionNotFound': return ({required Object region}) => '"${region}" bölgesi için otomatik seçim bulunamadı';
			case 'pages.settings.routing.perAppProxy.autoSelection.toast.alreadyInAuto': return 'Seçimleriniz zaten otomatik listede';
			case 'pages.settings.routing.perAppProxy.autoSelection.dialog.title': return 'Otomatik uygulama seçimi';
			case 'pages.settings.routing.perAppProxy.autoSelection.dialog.msg': return ({required Object region}) => 'Uygulama bazlı proxy için otomatik seçim özelliği, bölge "${region}" olarak değiştirildiği için devre dışı bırakıldı';
			case 'pages.settings.routing.region': return 'Bölge';
			case 'pages.settings.routing.regions.ir': return 'İran (ir) 🇮🇷';
			case 'pages.settings.routing.regions.cn': return 'Çin (cn) 🇨🇳';
			case 'pages.settings.routing.regions.ru': return 'Rusya (ru) 🇷🇺';
			case 'pages.settings.routing.regions.af': return 'Afganistan (af) 🇦🇫';
			case 'pages.settings.routing.regions.id': return 'Endonezya (id) 🇮🇩';
			case 'pages.settings.routing.regions.tr': return 'Türkiye (tr) 🇹🇷';
			case 'pages.settings.routing.regions.br': return 'Brezilya (br) 🇧🇷';
			case 'pages.settings.routing.regions.other': return 'Diğer';
			case 'pages.settings.routing.balancerStrategy.title': return 'Balancer stratejisi';
			...
			case 'pages.settings.routing.blockAds': return 'Reklamları engelle';
			case 'pages.settings.routing.bypassLan': return 'LAN\'ı atla';
			case 'pages.settings.routing.resolveDestination': return 'Hedefi çözümle';
			case 'pages.settings.routing.ipv6Route': return 'IPv6 rotası';
			case 'pages.settings.routing.ipv6Modes.disable': return 'Devre dışı bırak';
			case 'pages.settings.routing.ipv6Modes.enable': return 'Etkinleştir';
			case 'pages.settings.routing.ipv6Modes.prefer': return 'Tercih et';
			case 'pages.settings.routing.ipv6Modes.only': return 'Sadece';
			case 'pages.settings.routing.routeRule.title': return 'Yönlendirme kuralları';
			...
			case 'pages.settings.routing.routeRule.deleteRule': return 'Kuralı sil';
			case 'pages.settings.routing.routeRule.createRule': return 'Yeni kural oluştur';
			case 'pages.settings.routing.routeRule.rule.title': return 'Kural';
			case 'pages.settings.routing.routeRule.rule.ruleChanged': return 'Kural değiştirildi';
			case 'pages.settings.routing.routeRule.rule.ruleChangedMsg': return 'Düzenlemelerinizi kaydetmek istiyor musunuz?';
			...
			case 'pages.settings.routing.routeRule.androidApps.pageTitle': return 'Android uygulamaları';
			case 'pages.settings.routing.routeRule.androidApps.showSystemApps': return 'Sistem uygulamalarını göster';
			case 'pages.settings.routing.routeRule.androidApps.hideSystemApps': return 'Sistem uygulamalarını gizle';
			case 'pages.settings.routing.routeRule.androidApps.clearSelection': return 'Seçimi temizle';
			case 'pages.settings.routing.routeRule.androidApps.uninstalled': return 'Kaldırıldı';
			...
			case 'pages.settings.dns.enableDnsRouting': return 'DNS yönlendirmeyi etkinleştir';
			...
			case 'pages.settings.inbound.serviceModes.tunService': return 'VPN servisi';
			...
			case 'pages.settings.inbound.shortServiceModes.tunService': return 'VPN servisi';
			...
			case 'pages.settings.inbound.allowConnectionFromLan': return 'VPN\'i yerel ağda paylaş';
			...
			case 'pages.settings.warp.enable': return 'WARP\'ı etkinleştir';
			case 'pages.settings.warp.generateConfig': return 'WARP yapılandırması oluştur';
			case 'pages.settings.warp.configGenerated': return 'WARP yapılandırması oluşturuldu';
			case 'pages.settings.warp.missingConfig': return 'WARP yapılandırması eksik';
			case 'pages.settings.warp.detourMode': return 'Yönlendirme modu';
			case 'pages.settings.warp.detourModes.proxyOverWarp': return 'Proxy\'leri WARP üzerinden yönlendir';
			case 'pages.settings.warp.detourModes.warpOverProxy': return 'WARP\'ı proxy\'ler üzerinden yönlendir';
			case 'pages.settings.warp.detourModes.proxyOverWarpExplain': return 'Proxy\'lerin engelini WARP ile kaldır';
			case 'pages.settings.warp.detourModes.warpOverProxyExplain': return 'WARP ile ekstra güvenlik';
			case 'pages.settings.warp.licenseKey': return 'Lisans anahtarı';
			case 'pages.settings.warp.cleanIp': return 'Temiz IP';
			case 'pages.settings.warp.port': return 'Port';
			case 'pages.settings.warp.noise.count': return 'Gürültü sayısı';
			case 'pages.settings.warp.noise.mode': return 'Gürültü modu';
			case 'pages.settings.warp.noise.size': return 'Gürültü boyutu';
			case 'pages.settings.warp.noise.delay': return 'Gürültü gecikmesi';
			...
			case 'connection.secure': return 'WARP ile güvende';
			...
			case 'errors.warp.missingLicense': return 'WARP lisansı eksik';
			...
			case 'solanaAuth.subtitle': return 'Solana blok zincirinde güvenli VPN';
			case 'solanaAuth.connecting': return 'Bağlanıyor...';
			case 'solanaAuth.openWallet': return 'Onaylamak için cüzdanı açın';
			case 'solanaAuth.tryAgain': return 'Tekrar dene';
			case 'solanaAuth.loginWithSolana': return 'Solana ile Giriş Yap';
			case 'solanaAuth.supportedWallets': return 'Phantom • Solflare • Trust Wallet';
			case 'solanaAuth.infoCard': return 'Verileriniz gizli kalır. Şifre yok — sadece cüzdanınız.';
			case 'solanaAuth.HiddifyCore': return 'Solana Shield VPN';
			case 'solanaAuth.errors.cancelled': return 'Bağlantı iptal edildi. Tekrar dene.';
			case 'solanaAuth.errors.timeout': return 'Zaman aşımı. Cüzdanın kurulu olduğundan emin olun.';
			case 'solanaAuth.errors.notFound': return 'Solana cüzdanı bulunamadı. Phantom veya Solflare yükleyin.';
			case 'solanaAuth.errors.channelError': return 'Cüzdan iletişim hatası. Uygulamayı yeniden başlatın.';
			case 'solanaAuth.errors.unknown': return 'Bağlantı başarısız';
			case 'solanaAuth.errors.rawPrefix': return 'Hata: ';
			case 'walletSection.title': return 'Solana Cüzdanı';
			case 'walletSection.addressCopied': return 'Adres kopyalandı';
			case 'walletSection.logout': return 'Çıkış Yap';
			case 'walletSection.copyAddress': return 'Adresi Kopyala';
			default: return null;
		}
	}
}
